...
lines(4) = plot(bgDates, bgDeaths, '-', 'Color', color); 
lines(5) = plot(spDates, spDeaths, '-', 'Color', color); 
lines(6) = plot(geDates, geDeaths, '-', 'Color', color); 
lines(7) = plot(nyDates, nyDeaths, '-', 'Color', color); 
lines(8) = plot(auDates, auDeaths, '-', 'Color', color); 
lines(9) = plot(frDates, frDeaths, '-', 'Color', color); 
lines(10) = plot(itDates, itDeaths, '-', 'Color', color); 
lines(11) = plot(ukDates, ukDeaths, '-', 'Color', color); 
lines(12) = plot(nlDates, nlDeaths, '-', 'Color', color); 
